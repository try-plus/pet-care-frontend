    ...
    <main >
      ...
      <section className='mx-80 flex flex-col'>
        ...
        <ul className='flex flex-row justify-between text-center'>
          <li>
            <div>
              <Image src={training} alt='its a dog' className='mx-auto'/>
            </div>
            <div className='bg-cyan-900'>
              <h3 className='text-amber-300'>Anna & Tobby</h3>
              <p className='text-white'>Amazing Products & Delivery on time.</p>
              <p>bones</p>
            </div>
          </li>
          <li>
      ...
      <section>
        <div>
          ...
          <div>
            <input type="text" />
            <button className='w-[192.69px] h-[59.60px] bg-cyan-900 rounded text-white'>Submit now</button>
          </div>
        </div>
        <ul>
          <li>
          ...
          <li>
            ...
            <p>(616)-459-8622</p>
            <p>3236 Howard Street ,Grand <br /> Rapids,MI Michigan</p>
          </li>
          <li>
            <h3>Health care</h3>
            <p>(616)-556-5896</p>
