...
export default function Nav() {
  return (
    <div className=' flex flex-col mt-6 xl:mt-14 xl:flex-row xl:justify-between '>
      <Image
      className=' w-48 mx-auto mb-10 xl:ml-20 xl:mr-32'
        alt='logo'
        src={logo}
      />  
      <ul className=' flex flex-col mx-auto text-center xl:flex-row xl:mr-48 xl:text-lg'>
        <li className='font-bold mb-2 xl:mr-14 my-auto'>
